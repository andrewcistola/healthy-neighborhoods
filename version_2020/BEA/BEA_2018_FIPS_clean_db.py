...
df_CAGDP1 = pd.read_csv("hnb/BEA/2018/CAGDP/CAGDP1/CAGDP1__ALL_AREAS_2001_2018.csv", encoding = "ISO-8859-1") # Import dataset saved as csv in _data folder
df_CAGDP2 = pd.read_csv("hnb/BEA/2018/CAGDP/CAGDP2/CAGDP2__ALL_AREAS_2001_2018.csv", encoding = "ISO-8859-1") # Import dataset saved as csv in _data folder
df_CAGDP8 = pd.read_csv("hnb/BEA/2018/CAGDP/CAGDP8/CAGDP8__ALL_AREAS_2001_2018.csv", encoding = "ISO-8859-1") # Import dataset saved as csv in _data folder
df_CAGDP9 = pd.read_csv("hnb/BEA/2018/CAGDP/CAGDP9/CAGDP9__ALL_AREAS_2001_2018.csv", encoding = "ISO-8859-1") # Import dataset saved as csv in _data folder
df_CAGDP11 = pd.read_csv("hnb/BEA/2018/CAGDP/CAGDP11/CAGDP11__ALL_AREAS_2002_2018.csv", encoding = "ISO-8859-1") # Import dataset saved as csv in _data folder
df_CAINC1 = pd.read_csv("hnb/BEA/2018/CAINC/CAINC1/CAINC1__ALL_AREAS_1969_2018.csv", encoding = "ISO-8859-1") # Import dataset saved as csv in _data folder
df_CAINC4 = pd.read_csv("hnb/BEA/2018/CAINC/CAINC4/CAINC4__ALL_AREAS_1969_2018.csv", encoding = "ISO-8859-1") # Import dataset saved as csv in _data folder
df_CAINC30 = pd.read_csv("hnb/BEA/2018/CAINC/CAINC30/CAINC30__ALL_AREAS_1969_2018.csv", encoding = "ISO-8859-1") # Import dataset saved as csv in _data folder
...
df_label.to_csv(r"hnb/BEA/2018/CAGDP/BEA_2018_CAGDP_label.csv") # Export df as csv
...
df_CAGDP.to_csv(r"hnb/BEA/2018/CAGDP/BEA_2018_CAGDP_full.csv") # Export df as csv

## Combine CAINC tables

### Stack CAINC Data Frames
...
### Export feature labels
df_label.to_csv(r"hnb/BEA/2018/CAINC/BEA_2018_CAINC_label.csv") # Export df as csv
...
### Export full CAGDP table
df_CAINC.to_csv(r"hnb/BEA/2018/CAINC/BEA_2018_CAINC_full.csv") # Export df as csv
...
df_2010 = df_index.loc[:, df_index.columns.str.contains('2018')] # Select columns by string value, subset for 2010 census boundaires
...
df_BEA.to_sql('BEA_2018_FIPS', con, if_exists = 'replace', index = False)
...
df_bea = df_bea.set_index("FIPS") # Set column as index
df_bea = df_bea.loc[:, df_bea.columns.str.contains('2018')] # Select columns by string value
df_bea.head()
df_bea.to_csv(r"hnb/BEA/2018/BEA_2018_FIPS_full.csv") # Export df as csv

############# 19 Oct 20 Lables

df_l2 = pd.read_csv("allocativ/hnb/BEA/2018/CAINC/BEA_2018_CAINC_label.csv", low_memory = 'false') # Import dataset saved as csv in _data folder
df_l1 = pd.read_csv("allocativ/hnb/BEA/2018/CAGDP/BEA_2018_CAGDP_label.csv", low_memory = 'false') # Import dataset saved as csv in _data folder
df_label = pd.concat([df_l1, df_l2]) # Combine rows with same columns
df_label.to_csv(r"allocativ/hnb/BEA/2018/BEA_2018_FIPS_label.csv") # Export df as csv