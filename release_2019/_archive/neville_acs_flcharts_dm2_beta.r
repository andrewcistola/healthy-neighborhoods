...
## Florida Charts Census Tract Mortality Data: The R Project for Statistical Computing Script by DrewC!
...
df_yrbs = read.csv("_data/flcharts_50_dm2.csv.csv") # Import dataset from _data folder
